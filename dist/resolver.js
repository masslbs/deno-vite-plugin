...
export function log(m, context = "resolver.ts") {
...
export async function resolveDeno(id, cwd, cache, lock) {
    resolveLog("called");
...
export async function resolveViteSpecifier(id, cache, root, lock, importer) {
    // Resolve import map
